            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  AppSpacing.bigGap,
                  InputHeadTitle(
                    text: context.translate().username.firstToUpperCase(),
                  ),
                  AppSpacing.semiMediumGap,
                  TextFormField(
                    decoration: InputDecoration(
                      labelText:
                          context.translate().username.firstToUpperCase(),
                    ),
                    autofillHints: const [
                  ...
                  InputHeadTitle(
                    text: context.translate().password.firstToUpperCase(),
                  ),
                  AppSpacing.semiMediumGap,
                  TextFormField(
                    obscureText: true,
                    ...
                    decoration: InputDecoration(
                      labelText:
                          context.translate().password.firstToUpperCase(),
                    ),
                    validator: (pwd) {
